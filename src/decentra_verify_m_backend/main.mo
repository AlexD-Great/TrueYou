...
persistent actor Filevault {
  ...
  private func isAdmin(caller: Principal) : Bool {
    ...
    if (callerText == "k2ir2-52b5o-sc6f7-ai4bg-vdrf3-wghtz-xz4us-77lr6-y6cfv-5qlvy-sqe" || callerText == "ues2k-6iwxj-nbezb-owlhg-nsem4-abqjc-74ocv-lsxps-ytjv4-2tphv-yqe") {
